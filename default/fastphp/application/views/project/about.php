        ...
        <div class="cms-g">
             <div class="am-hide-sm-only am-u-md-3 am-u-lg-3">
                 <div class="com-nav-left">
                     <h1><em>关于我们</em><i>ABOUT US</i></h1>
                        <ul >
                            <?php print_r($abouttype['a_type_name'])?>
                            <?php foreach($abouttype as $key=>$val){?>
                                <li><a value="<?= $val['id']?>" class='about'><?= $val['type']?></a></li>
                            <?php }?>
            ...
            <div class="am-u-sm-12 am-u-md-9 am-u-lg-9">
                ...
                <div class="com-nav-content">
                    <span id="span">大冶市云阿拉丁科技有限公司创建于2015年1月5日，总部位于青铜故里——大冶市。公司致力于帮助传统行业实现在互联网时代</span>
                </div>
            </div>
        </div>
    </div>
...
<script>
    $(document).on('click',".about",function(){
        ...
        $.ajax({
            url:"http://www.wanghongjun.top/fastphp/index.php/?c=project&a=about_do",
            data:{id:id},
            type:'post',
            dataType:"json",
