    ...
    <div class="index-nav">
        <div class="cms-g">
                ...
                <div class="am-u-sm-6 am-u-md-6 am-u-lg-3">
                    <div class="index-nav-item">
                        <div class="index-nav-img">
                            <img src="<?php echo $val['type_img']?>" />
                        </div>
                        <div class="index-nav-info">
                            <h1><?php echo $val['type_name']?></h1>
                            <h2><?php echo $val['intro']?></h2>
            ...
            <!-- <div class="am-u-sm-6 am-u-md-6 am-u-lg-3">
                <div class="index-nav-item">
                    <div class="index-nav-img">
                        <img src="images/index_nav02.png" />
                    </div>
                    <div class="index-nav-info">
                        <h1>LED电源</h1>
                        <h2>专业技术 高效耐用</h2>
            ...
            <div class="am-u-sm-6 am-u-md-6 am-u-lg-3">
                <div class="index-nav-item">
                    <div class="index-nav-img">
                        <img src="images/index_nav03.png" />
                    </div>
                    <div class="index-nav-info">
                        <h1>LED灯具</h1>
                        <h2>领先科技 节能高效</h2>
            ...
            <div class="am-u-sm-6 am-u-md-6 am-u-lg-3">
                <div class="index-nav-item">
                    <div class="index-nav-img">
                        <img src="images/index_nav04.png" />
                    </div>
                    <div class="index-nav-info">
                        <h1>通讯模块</h1>
                        <h2>超强信号 优质体验</h2>
            ...
            <div class="am-u-sm-12 am-u-md-12 am-u-lg-4">
                <div class="index-content-left">
                        ...
                        <div class="am-slider am-slider-default" data-am-flexslider id="demo-slider-0">
                            <ul class="am-slides">
                                <?php foreach($res_goods as $key=>$val){?>
                                    <li><img src="<?php echo $val['img']?>" alt=""></li>
                                <?php }?>
                                <!-- <li><img src="images/index-content-left-01.png" /></li>
                                <li><img src="images/index-content-left-01.png" /></li>
                                <li><img src="images/index-content-left-01.png" /></li>
                                <li><img src="images/index-content-left-01.png" /></li>
                                <li><img src="images/index-content-left-01.png" /></li>
                ...
                <div class="index-content-center">
                    ...
                    <ul>
                        <?php foreach($News as $key=>$val){?>
                            <li><a href="#"><span><?= $val['new_title']?></span><em><?= $val['time']?></em></a></li>
                        <?php }?>
