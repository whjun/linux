...
<!-- 		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="price" id="" placeholder="" value="" class="input-text" style="width:98%">
				元</div>
		</div>
		<!-- <div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="date" name="start_time" id="datemin" class="input-text">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">销售结束时间：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="date" name="end_time" id="datemax" class="input-text">
			</div>
		</div>
<!-- 		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<div class="uploader-thum-container">
                    ...
                    <input type="hidden" name="img_src" id="logo-input"/>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button type="submit" id="btn" class="btn btn-primary radius">保存并提交审核</button>
				<!-- <button type="" class="btn btn-secondary radius">保存草稿</button> -->
...
<script type="text/javascript">
	$("#btn").click(function(){
		...
		$.ajax({
			url:"../index.php/product_add_do",
			data:formData,
			type:"post",
			success:function(res){
				console.log(res);
				if(res.code == 200){
					alert("添加成功");location.href='../index.php/product_list';
				}else{
					alert("添加失败");
				}
			}
